    ...
    <div class="collage">
        <div class="collage__bg">
            ...
            <div class="collage__inhoud">
                <p class="collage__tag"><span class="dash light collage-dash">&mdash;</span> <span>gratis<span><span
                                class="vertical-dash">&#124;</span> </p>
        ...
        <div class="brochure__inhoud">
            ...
            <div class="brochure__flex">
                ...
                <p class="brochure__text">
                    ...
                    <br><br>
                    <a class="brochure__link" target="_blank"
                        href="assets/img/home/18_07_04_folderstraattheater.pdf">download de brochure</a>
                </p>
            </div>
        </div>
    </article>
        ...
        <article class="contact__flex">
            ...
            <aside class="contact__nieuws">
                ...
                <form class="contact__form">
                    <input class="contact__form__input" name="email" type="email" placeholder="Graag jouw email"
                        required />
